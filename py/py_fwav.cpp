...
void BindFwav(py::module& parent) {
  ...
  py::class_<audio::fwav::InfoBlock>(m, "WaveInfo")
      ...
      .def_readwrite("original_loop_start_frame",
                     &audio::fwav::InfoBlock::original_loop_start_frame);
  ...
  py::class_<audio::fwav::Fwav, std::shared_ptr<audio::fwav::Fwav>, audio::IAssetFile>(m, "Fwav")
      ...
      .def("to_binary",
           py::overload_cast<util::Endianness>(&audio::fwav::Fwav::ToBinary, py::const_),
           "endian"_a)
      .def_property("encoding", py::overload_cast<>(&audio::fwav::Fwav::Encoding, py::const_),
                    py::overload_cast<audio::SampleFormat>(&audio::fwav::Fwav::Encoding))
      .def_property("is_loop", py::overload_cast<>(&audio::fwav::Fwav::isLoop, py::const_),
                    py::overload_cast<bool>(&audio::fwav::Fwav::isLoop))
      .def_property("sample_rate", py::overload_cast<>(&audio::fwav::Fwav::SampleRate, py::const_),
      ...
      .def_property("original_loop_start_frame",
      ...
      .def_property("channel_infos",
                    ...
                    py::overload_cast<const std::vector<audio::fwav::ChannelInfo>&>(
                        &audio::fwav::Fwav::ChannelInfos))
      ...
      .def_property(
          "samples", py::overload_cast<>(&audio::fwav::Fwav::Samples, py::const_),
          py::overload_cast<const std::vector<audio::Channel>&>(&audio::fwav::Fwav::Samples))
      .def_property("endian", py::overload_cast<>(&audio::fwav::Fwav::Endianness, py::const_),
