...
void BindFstm(py::module& parent) {
  ...
  py::class_<audio::fstm::StreamSoundInfo>(m, "StreamSoundInfo")
      ...
      .def_readwrite("last_block_sample_count",
                     &audio::fstm::StreamSoundInfo::last_block_sample_count)
      .def_readwrite("last_block_padding_size",
                     &audio::fstm::StreamSoundInfo::last_block_padding_size)
      .def_readwrite("size_of_seek_info_atom",
                     &audio::fstm::StreamSoundInfo::size_of_seek_info_atom)
      .def_readwrite("seek_info_interval_samples",
                     &audio::fstm::StreamSoundInfo::seek_info_interval_samples)
  ...
  py::class_<audio::fstm::InfoBlock>(m, "StreamInfoBlock")
      .def(py::init<>())
      .def_property(
          "stream_info", py::overload_cast<>(&audio::fstm::InfoBlock::StreamInfo, py::const_),
          py::overload_cast<audio::fstm::StreamSoundInfo>(&audio::fstm::InfoBlock::StreamInfo))
      .def_property("track_infos",
                    py::overload_cast<>(&audio::fstm::InfoBlock::TrackInfos, py::const_),
                    py::overload_cast<const std::vector<audio::fstm::TrackInfo>&>(
                        &audio::fstm::InfoBlock::TrackInfos))
      ...
      .def_property("channel_infos",
                    py::overload_cast<>(&audio::fstm::InfoBlock::DetailChannelInfos, py::const_),
                    py::overload_cast<const std::vector<audio::DspAdpcmInfo>&>(
                        &audio::fstm::InfoBlock::DetailChannelInfos))
      .def("get_channel_info", &audio::fstm::InfoBlock::GetDetailChannelInfo, "channel"_a)
      .def("set_channel_info", &audio::fstm::InfoBlock::SetDetailChannelInfo, "info"_a,
           "channel"_a);
  ...
  py::class_<audio::fstm::Fstm>(m, "Fstm")
      ...
      .def("to_binary",
           py::overload_cast<util::Endianness>(&audio::fstm::Fstm::ToBinary, py::const_),
           "endian"_a)
      .def_property("info", py::overload_cast<>(&audio::fstm::Fstm::Info, py::const_),
                    py::overload_cast<audio::fstm::InfoBlock>(&audio::fstm::Fstm::Info))
      .def_property("seek_infos", py::overload_cast<>(&audio::fstm::Fstm::SeekInfos, py::const_),
                    py::overload_cast<const std::vector<std::vector<audio::fstm::SeekInfo>>&>(
                        &audio::fstm::Fstm::SeekInfos))
