...
void BindFstp(py::module& parent) {
  ...
  py::class_<audio::fstp::Fstp, std::shared_ptr<audio::fstp::Fstp>, audio::IAssetFile>(m, "Fstp")
      ...
      .def("to_binary",
           py::overload_cast<util::Endianness>(&audio::fstp::Fstp::ToBinary, py::const_),
           "endian"_a)
      .def_property("version", py::overload_cast<>(&audio::fstp::Fstp::Version, py::const_),
                    py::overload_cast<u32>(&audio::fstp::Fstp::Version))
      .def_property("info", py::overload_cast<>(&audio::fstp::Fstp::Info, py::const_),
                    py::overload_cast<audio::fstm::InfoBlock>(&audio::fstp::Fstp::Info))
      .def_property(
          "data", py::overload_cast<>(&audio::fstp::Fstp::Data, py::const_),
          py::overload_cast<const audio::fstp::PrefetchDataBlock&>(&audio::fstp::Fstp::Data))
      .def_property("endian", py::overload_cast<>(&audio::fstp::Fstp::Endianness, py::const_),
