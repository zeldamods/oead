...
* `AMTA` <>_ (audio meta): Version 4.0 is supported
* `BARS` <>_ (binary audio resource): Version 1.1 is supported
* `BYML <https://zeldamods.org/wiki/BYML>`_ (binary YAML): Versions 1, 2, 3, and 4 are supported.
* `FSTM` <>_ (cafe stream): Version 4.0.0 is supported
* `FSTP` <>_ (cafe stream prefetch): Version 2.1.0 is supported
* `FWAV` <>_ (cafe wave): Version 1.2.0 is supported
